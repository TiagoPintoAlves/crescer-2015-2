...
public class ExercitoElfoTest{
    ...
    public void exercitoElfoAlistarEhBuscarElfosVerdes(){
        ...
        exercitoElfo.alistarElfoVerde(green1);
        exercitoElfo.alistarElfoVerde(green2);
        exercitoElfo.alistarElfoVerde(green3);
    ...
    public void exercitoElfoAlistarEhBuscarElfosNoturnos(){
        ...
        exercitoElfo.alistarElfoNoturno(dark1);
        exercitoElfo.alistarElfoNoturno(dark2);
        exercitoElfo.alistarElfoNoturno(dark3);
